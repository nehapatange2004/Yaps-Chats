...
import {AnimatedChat} from "./AnimatedChat.tsx";
    ...
    <div className="w-full h-[calc(100dvh-84px)] flex flex-row justify-center rounded-4xl backdrop-brightness-110 border border-current/10 overflow-hidden">
      <form className="flex flex-col gap-6 z-2 h-fit justify-center mt-10 pt-4 pb-8 rounded-lg w-80 px-6 py-8 ring shadow-lg shadow-accent-content/25 bg-[#6666661a] backdrop-blur-[1px]">
        ...
        <div className="text-[0.8rem]">
          ...
          <NavLink
            to="/signin"
            className="text-accent-content hover:underline active:scale-90 active:underline"
          >
            {" "}
            Sign In
          </NavLink>
      ...
      <div className="size-80 sm:size-[500px] absolute bottom-[-200px] left-0 z-0 opacity-30">
        <AnimatedChat />
      </div>
      <div className="hidden sm:block rotate-y-180 sm:size-[350px] absolute top-[-20px] right-[-20px] z-0 opacity-30">
        <AnimatedChat />
      </div>
    </div>
  );
